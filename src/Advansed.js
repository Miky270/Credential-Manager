...
function main() {
    ...
    while (true) {
        ...
        console.log("6. Generazione password");
        console.log("7. The End");
        ...
        switch (choice) {
            ...
            case "5": 
                ...
                break;
            case "6":
                console.log("PASSWORD SICURA >>>>>>" + CredentialManager.generateSecurePassword(prompt("Inserisci lunghezza password >>>")));
                break;
            case "7":
